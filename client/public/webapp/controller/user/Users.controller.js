sap.ui.define([
	...
	return BaseController.extend("template.cf.mbd.tmp1.controller.user.Users", {
		onInit: function(){
		...
		_getDialog : function () {
        	if (!this._oDialog) {
            	this._oDialog = sap.ui.xmlfragment("template.cf.mbd.tmp1.view.user.UserCreate", this);
